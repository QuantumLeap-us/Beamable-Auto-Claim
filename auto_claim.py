...
# Get Cookie from environment variables, no default value for security
COOKIE = os.getenv('BEAMABLE_COOKIE', '')
if not COOKIE:
    logger.error("BEAMABLE_COOKIE not found in environment variables. Please set it in the .env file.")
    logger.error("Exiting program due to missing cookie.")
    exit(1)
